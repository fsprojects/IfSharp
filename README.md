...
See our [release repository](https://github.com/BayardRock/IfSharp/releases). [Installation documentation]([documenation](http://bayardrock.github.io/IfSharp/insallation.html).
